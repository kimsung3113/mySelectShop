...
@WebMvcTest(
        controllers = {UserController.class, ProductController.class}, // Test할 Controller 지정
...
class UserProductMvcTest {
    ...
    @BeforeEach
    public void setup() {   // 우리가 만든 Filter를 넣어준다.
    ...
    void test1() throws Exception {
        ...
        mvc.perform(get("/api/user/login-page"))
                ...
                .andExpect(view().name("login")) // 뷰 name이 login인지?
                .andDo(print());
    }
    ...
    void test3() throws Exception {
        // given (클라이언트에서 Json 형식의 데이터를 주니깐 만든다)
        this.mockUserSetup();
